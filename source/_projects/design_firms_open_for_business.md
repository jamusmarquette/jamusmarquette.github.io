...
title: Design Firms Open For Business
page_label: Design Firms Open For Business

permalink: /project/design_firms_open_for_business/
...
hero_rows:
  - items:
      - col: col-16
        image: /project/design_firms_open_for_business/img/00_jamus_marquette_design_firms_open_for_business_by_steven_heller_and_lita_talarico_book_design.jpg

description:
  - >
    A look inside a diverse collection of design establishments from all over the world featuring a unique blend of analysis, biography, select works, and photos of each establishment—providing an array of successful models and fresh ideas.

  - >
    A design-centered visual language was developed by combining a CMYK color scheme with a style originating from “Open For Business” signage, as well as cover designs, and a system for layouts.
