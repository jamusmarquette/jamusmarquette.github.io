...
page_label: Theater Posters

permalink: /project/theater_campaigns/
...
description:
  - >
    Theater posters promoting a variety of performances, designed to work as flexible systems across a variety of formats.

  - >
    Underlying concepts unique to each performance were defined through script studies, attendance of play readings, and consultation with directors, playwrights, and marketing teams, to create original artwork that charms theater enthusiasts into the seats of a variety of Off-Broadway playhouses.
...
credits:
  - role: Art Direction
    name: "Kevin Brainard, Darren Cox, Adriana Marquette, Sam Eckersley, Stuart Rogers"

  - role: Photography
    name: "Serge Neville (Blood From A Stone, Marie and Bruce), Darren Cox (Happy Days), Jamus Marquette (everything else)"

  - role: Design
    name: "Jamus Marquette, Adriana Marquette"
...
media_rows:
  ...
  - section: in-use
    items:
      ...
      - col: col-md-8
        image: /project/theater_campaigns/img/13-jamus-marquette-theater-poster-design-completeness-a-new-play-by-itmar-moses-and-assistance-directed-by-pam-machinnon.jpg
